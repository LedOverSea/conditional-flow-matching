@echo off
echo 1.CFMLitModule...
python "src/train_eb_phate.py" "model._target_=src.models.cfm_module.CFMLitModule"

echo 2.RectifiedFlowLitModule...
python "src/train_eb_phate.py" "model._target_=src.models.cfm_module.RectifiedFlowLitModule" 
...
python "src/train_eb_phate.py" "model._target_=src.models.cfm_module.SBCFMLitModule"

echo 6.SF2MLitModule...
python "src/train_eb_phate.py" "model=sf2m" 
